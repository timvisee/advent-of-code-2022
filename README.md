...
| [day 13](https://adventofcode.com/2022/day/13)  | [` 0.238 ms`](./day13a/src/main.rs) | [` 0.310 ms`](./day13b/src/main.rs) |

|              | one-by-one (1 CPU core)                  | parallel                                     |
|:-------------|:-----------------------------------------|:---------------------------------------------|
| _everything_ | [`59.10 ms`](./runner/src/bin/runner.rs) | [`51.86 ms`](./runner/src/bin/runner-par.rs) |
